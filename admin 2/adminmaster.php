        ...
        <div class="row">
            <div class="col-xs-12">
                <div class="box">
                    ...
                    <?php } ?>
                    <div class="box-header">
                        <a href="addAdmin.php" class="btn btn-primary">Add Record</a>
                    </div>
                    <div class="box-body">
                        <?php
                        $selData = "SELECT * FROM admin order by a_id DESC";
                        ...
                        <table id="example" class="table table-bordered table-hover">
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td>
                                        <?php if($adminId!=1){?>
                                        <a href="frmUpdateAdmin.php?id=<?php echo $adminId; ?>"><i class="fa fa-edit"></i></a>
                                        &nbsp;&nbsp;&nbsp;
                                        <a href="code/admincode.php?del=<?php echo $adminId; ?>" onclick="return confirm('Are you sure you want to delete data?');"><i class="fa fa-trash"></i></a>
                                        <?php } ?>
                                    </td>
                                </tr>
                            <?php
